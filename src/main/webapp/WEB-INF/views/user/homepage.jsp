...
<body>
	<div class="container">
		...
		<div class="row align-items-center my-5">
			<div class="col-lg-7">
				<img class="img-fluid rounded mb-4 mb-lg-0" src="data:image/jsp;base64,${bestSellImage.base64Image}" alt="">
			</div>
			<!-- /.col-lg-8 -->
			<div class="col-lg-5">
				<h1 class="font-weight-light">${bestProduct.name}</h1>
				<p>${bestProduct.description}</p>
				<a class="btn btn-primary" href="ChiTiet?id=${bestProduct.id}">Chi TIết!</a>
			</div>
			<!-- /.col-md-4 -->
		</div>
		<!-- /.row -->
